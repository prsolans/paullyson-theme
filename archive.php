...
<div class="wrapper section medium-padding">
	...
	<div class="page-title section-inner">
		...
		<?php elseif ( is_category() ) : ?>
			<h5><?php _e( 'Category', 'baskerville' ); ?></h5> <h3 class="post-title entry-title"><?php echo single_cat_title( '', false ); ?></h3>
		<?php elseif ( is_tag() ) : ?>
			<h5><?php _e( 'Tag', 'baskerville' ); ?></h5> <h3 class="post-title entry-title"><?php echo single_tag_title( '', false ); ?></h3>
		<?php elseif ( is_author() ) : ?>
			<?php $curauth = (isset($_GET['author_name'])) ? get_user_by('slug', $author_name) : get_userdata(intval($author)); ?>
			<h5><?php _e( 'Author', 'baskerville' ); ?></h5> <h3 class="post-title entry-title"><?php echo $curauth->display_name; ?></h3>
		<?php else : ?>
